    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse d-lg-block" id="navbarNavDropdown">
        <ul class="navbar-nav bg-light" style="border-radius: 15px;">
          ...
          <li class="nav-register nav-item  mx-3">
...
<div class="header  container">
    <div class="row">
    <div class="karamailimg text-left d-none d-sm-block d-md-none d-lg-block d-sm-none d-md-block d-lg-none d-xl-block">
      ...
      <div class="home-text-main text-center mx-5 pt-4 col-xl-12 col-6">
